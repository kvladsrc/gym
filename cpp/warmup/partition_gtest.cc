...
// Helper to test both partition schemes, mimicking the original bats test
// logic.
...
TEST(PartitionTest, EmptyArray) { TestPartitionSchemes({}, -1, {}); }

TEST(PartitionTest, OneElementArray) { TestPartitionSchemes({1}, 0, {1}); }
...
TEST(PartitionTest, OneElementNegative) { TestPartitionSchemes({-5}, 0, {-5}); }
