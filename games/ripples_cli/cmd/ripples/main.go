...
import (
	...
	"src/games/ripples_cli/pkg/engine"
	"src/games/ripples_cli/pkg/llm"
	"src/games/ripples_cli/pkg/model"
	"src/games/ripples_cli/pkg/tui"
	"src/games/ripples_cli/pkg/world"
...
func main() {
	// Define Flags
	worldPath := flag.String("world", "games/ripples_cli/assets/world.dot", "Path to the world DOT file")
