...
```bash
bazelisk build //games/ripples_cli/...
```
...
bazelisk run //games/ripples_cli/cmd/ripples -- --world $(pwd)/games/ripples_cli/assets/world.dot
```
...
- `-world`: Path to the DOT file defining the world (default:
    `games/ripples_cli/assets/world.dot`).
