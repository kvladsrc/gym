...
struct Config {
  ...
  bool use_gpu = false;
  bool use_blur = true;         // Apply 3x3 box blur to reduce pixelation
  ...
  bool divide_elite = true;          // Fill population with copies of best after subdivide
  bool divide_interpolate = false;    // Use bilinear interpolation when subdividing DNA
